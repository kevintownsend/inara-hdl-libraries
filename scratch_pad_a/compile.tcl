...
#synth_design -include_dirs ../. -top scratch_pad_synthesis -generic PORTS=32 -part xc7v2000t
synth_design -include_dirs ../. -top scratch_pad_synthesis -generic PORTS=4 -part xc7v2000t
#synth_design -include_dirs ../. -top scratch_pad -part xc7v2000t -max_bram 100 
